...
namespace Panda_Racing
{
    public partial class RacingForm : Form
    {
        ...
        private void SetupRaceTrack()
        {
            ...
            punters[0] = pFactory.getPunter("Jassi", MaximumBet, JassiBet); //getting Jassi object from factory class
            punters[1] = pFactory.getPunter("Harman", MaximumBet, HarmanBet); //getting Harman object from factory class
            punters[2] = pFactory.getPunter("Guri", MaximumBet, GuriBet); //getting Guri object from factory class
        ...
        private void JassiButton_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void GuriButton_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void Bets_Click(object sender, EventArgs e)
        {
            ...
            if (JassiButton.Checked)
            {
                PunterNum = 0;
            }
            if (HarmanRButton.Checked)
            {
                PunterNum = 1;
            }
            if (GuriRButton.Checked)
            {
                PunterNum = 2;
            }
